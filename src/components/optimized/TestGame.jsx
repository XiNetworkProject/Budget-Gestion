...
const TestGame = () => {
  ...
  useEffect(() => {
    ...
    const initGame = async () => {
      try {
        ...
        setStatus('Initialisation des systèmes...');
        
        // Utiliser app.view qui est un HTMLCanvasElement dans PixiJS v8
        if (app.view && app.view instanceof HTMLCanvasElement) {
          console.log('✅ TestGame: app.view est un HTMLCanvasElement valide');
          ...
          console.error('❌ TestGame: app.view n\'est pas un HTMLCanvasElement valide');
          setError('Impossible d\'accéder au canvas PixiJS');
          return;
        }
        ...
        setStatus('✅ Tous les systèmes initialisés avec succès');
  ...
  return (
    <Box sx={{ p: 2 }}>
      ...
      <Box ref={containerRef} sx={{ border: '1px solid #ccc', borderRadius: 1, minHeight: '600px' }} />

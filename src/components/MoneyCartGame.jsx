...
const MoneyCartGame = memo(() => {
  ...
  useEffect(() => {
    ...
    const layout = () => {
      ...
      // Centrage simple et efficace comme avant
    ...
    // Layout simple après initialisation
    setTimeout(() => {
      layout();
    }, 100);
  ...
  return (
    <div style={{ 
      ...
      {/* HUD SPINS LEFT - Gros panneau octogonal en haut à gauche comme dans le vrai jeu */}
      <div style={{
        position: 'absolute',
        top: '5%',
        left: '5%',
        ...
        boxShadow: `
          ...
          inset 0 0 15px rgba(74, 158, 255, 0.2)
        `,
        display: 'flex',
        flexDirection: 'column',
        alignItems: 'center',
        ...
        <div style={{
          ...
          textShadow: '0 0 10px rgba(74, 158, 255, 1)',
          marginBottom: '8px',
          letterSpacing: '2px'
        }}>SPINS LEFT</div>
        <div style={{
          ...
          textShadow: '0 0 20px rgba(255, 255, 255, 1), 0 0 30px rgba(74, 158, 255, 0.8)'
        }}>{ui.respins}</div>
      </div>

      {/* HUD TOTAL WIN - Gros panneau octogonal en haut à droite comme dans le vrai jeu */}
      <div style={{
        position: 'absolute',
        top: '5%',
        right: '5%',
